...
export let detailsOrder = (orderId) => async (dispatch, getState) => {
...
export let payOrder = (order, paymentResult) => async (dispatch, getState) => {
...
export let deleteOrder = (orderId) => async (dispatch, getState) => {
...
export let deliverOrder = (orderId) => async (dispatch, getState) => {
...
export let summaryOrder = () => async (dispatch, getState) => {
